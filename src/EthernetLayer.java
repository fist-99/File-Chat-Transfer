...
public class EthernetLayer implements BaseLayer {
	...
	//--------------------fileSend()함수----------------- stop and wait 사용 x
	...
	public synchronized boolean Receive(byte[] input) {
		...
		//------------------stop and wait - 채팅 ----------------
		if(temp_type == byte2ToInt((byte) 0x20, (byte) 0x82)){
			this.GetUpperLayer(0).Receive(null);
		}
		else if(temp_type == byte2ToInt((byte) 0x20, (byte) 0x81)) {
