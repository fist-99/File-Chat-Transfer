...
public class ChatFileDlg extends JFrame implements BaseLayer {
	...
	JTextArea ChattingArea; //채팅 화면
	JTextArea FileArea; //파일 이름 화면
	JTextArea srcMacAddress; //수신 Mac 주소
	JTextArea dstMacAddress; //목적 Mac 주소
	...
	public File getFile(){ //FileAppLayer에서 파일 접근자 설정
